...
public final class CreateFileLogEvent extends LoadLogEvent
{
            ...
            FormatDescriptionLogEvent descriptionEvent)
    {
        ...
        final int loadHeaderLen = descriptionEvent.postHeaderLen[LogEvent.LOAD_EVENT - 1];
        final int createFileHeaderLen = descriptionEvent.postHeaderLen[LogEvent.CREATE_FILE_EVENT - 1];

        copyLogEvent(buffer,
                ((header.type == LogEvent.LOAD_EVENT) ? (loadHeaderLen + headerLen)
